...
processing, we identified for Shakespeare `r nrow(tabs$Shakespeare)`
documents in total (ESTC `r sum(tabs$Shakespeare$source == "estc")`;
CERL `r sum(tabs$Shakespeare$source == "cerl")`), and for Cervantes
`r nrow(tabs$Cervantes)` documents in total (ESTC
`r sum(tabs$Cervantes$source == "estc")`; CERL
`r sum(tabs$Cervantes$source == "cerl")`).
...
```{r shakespeare-versusother, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=10, fig.height=5, out.width="800px"}
...
```{r shakespeare-tragedyvscomedy, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=10, fig.height=5, out.width="800px"}
auth <- "Shakespeare"
df <- tabs[[auth]]
...
```{r shakespeare-cervantes, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, out.width="800px", fig.height=6, fig.width=8}
...
```{r shakespeare-publisher, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=8, fig.height=4, out.width="800px"}
auth <- "Shakespeare"
