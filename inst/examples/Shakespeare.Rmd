...
```{r shakespeare-versusother, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=10, fig.height=6, out.width="800px"}
...
```{r shakespeare-tragedyvscomedy, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=9, fig.height=6, out.width="800px"}
auth <- "Shakespeare"
df <- tabs[[auth]]
