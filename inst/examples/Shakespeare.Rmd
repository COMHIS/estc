...
```{r shakespeare-read, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r shakespeare-versusother, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r shakespeare-tragedyvscomedy, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE}
auth <- "Shakespeare"
df <- tabs[[auth]]
...
for (auth in names(my.authors)) {
  p <- top_plot(tabs[[auth]], "title", ntop = length(unique(dfs$title)))
...
```{r shakespeare-publisher, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE}
auth <- "Shakespeare"
df <- tabs[[auth]]
