...
```{r shakespeare-versusother, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=8, fig.height=3, out.width="530px"}
...
```{r shakespeare-tragedyvscomedy, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=8, fig.height=3, out.width="530px"}
auth <- "Shakespeare"
df <- tabs[[auth]]
...
```{r shakespeare-titles, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.show="hold", out.width="260px", fig.height=10, fig.width=5}
for (auth in names(my.authors)) {
...
```{r shakespeare-publisher, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=8, fig.height=3, out.width="600px"}
auth <- "Shakespeare"
df <- tabs[[auth]]
