...
```{r shakespeare-read, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=8, fig.height=5, out.width="530px"}
...
```{r shakespeare-versusother, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=10, fig.height=7, out.width="600px"}
...
p <- ggplot(d, aes(x = publication_decade, y = freq, fill = author)) +
       ...
       ylab("Fraction of Titles") +
       scale_fill_grey() +
       guides(fill = guide_legend("Author")) +
       ggtitle("Publishing timeline")
print(p)
```
...
```{r shakespeare-tragedyvscomedy, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=10, fig.height=7, out.width="600px"}
auth <- "Shakespeare"
df <- tabs[[auth]]
...
```{r shakespeare-titles, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.show="hold", out.width="300px", fig.height=13, fig.width=6}
for (auth in names(my.authors)) {
...
```{r shakespeare-publisher, echo=FALSE, message=FALSE, warning=FALSE, echo=FALSE, fig.width=10, fig.height=5, out.width="800px"}
auth <- "Shakespeare"
df <- tabs[[auth]]
