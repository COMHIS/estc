 ...
 * 1093 [publication places](output.tables/publication_place_accepted.csv); available for 478782 documents (99%). 
 * 55 [publication countries](output.tables/country_accepted.csv); available for 478201 documents (99%).
