...
Top-20 publication places are shown together with the number of documents. This info is available for 478687 documents (99%). There are 1070 unique publication places. Overall 87.6% of the places could be matched to geographic coordinates (from the [Geonames](http://download.geonames.org/export/dump/) database).
...
|name      |      n|   fraction|
|:---------|------:|----------:|
|England   | 348510| 72.4244345|
|Scotland  |  40157|  8.3450920|
|USA       |  31815|  6.6115273|
|Ireland   |  27545|  5.7241716|
|Ambiguous |  19364|  4.0240646|
