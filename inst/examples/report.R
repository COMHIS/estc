...
library(rmarkdown)
rmarkdown::render("report.Rmd", params = list(min.year = 1470, max.year = 1880, subtitle = "My subtitle", idsource = "freewill.txt", update.bibliographica = FALSE, time.window = 10))
