...
# The most differing pagecounts in ESTC/ECCO
o <- df$original_row[order(abs(df$pagecount.ecco - df$pagecount) / (df$pagecount.ecco + df$pagecount), decreasing = TRUE)[1:200]];
comptab <- cbind(
