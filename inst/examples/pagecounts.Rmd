...
#o <- df$original_row[order(abs(df$pagecount.ecco - df$pagecount) / (df$pagecount.ecco + df$pagecount), decreasing = TRUE)[1:10000]];
#comptab <- cbind(
...
#	)
#write.table(comptab, file = "~/tmp/estc_ecco_pagecount_mismatches.csv", quote = F, row.names = F)	
```
