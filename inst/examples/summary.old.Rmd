...
```{r summary-histograms, echo=FALSE, message=FALSE, warning=FALSE, fig.width=7, fig.height=4}
...
```{r summary-bars, echo=FALSE, message=FALSE, warning=FALSE, fig.width=9, fig.height=7}
factor.fields <- c("title", "topic", "author_name", "gatherings", "obl", "publisher", "publication_place", "publication_country", "author_unique", "author_gender")
