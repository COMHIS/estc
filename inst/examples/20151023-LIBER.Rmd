...
```{r 20151023LIBER-1, echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.height=6, fig.width=7.5}
library(ggplot2)
library(dplyr)
...
p <- p + theme(axis.text.x = element_text(size = 35), axis.text.y = element_text(size = 35), axis.title.x = element_text(size = 35), axis.title.y = element_text(size = 35))
print(p)	 
```
