...
```{r 20151023LIBER-5, echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.height=6, fig.width=7}
theme_set(theme_bw(20))
...
p <- p + theme(axis.text.x = element_text(size = 30), axis.text.y = element_text(size = 30), axis.label.x = element_text(size = 30), axis.label.y = element_text(size = 30))
print(p)	 
```
