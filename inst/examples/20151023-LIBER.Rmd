...
<<setup, include="FALSE">>=
opts_chunk$set(fig.path = "figure_20151023_LIBER/",
#fig.lp = "",
#out.width=".05\\textwidth",
#fig.pos="b",
#fig.keep="high",
#fig.show="hold",
#fig.align="center",
...
#par(las = 1)
#options(width = 30, scipen = 4, digits = 3)
@
...
```{r 20151023LIBER-5, echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.height=6, fig.width=10}
theme_set(theme_bw(20))
...
```{r 20151023LIBER-8, echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.height=6, fig.width=8}
df <- df.preprocessed
theme_set(theme_bw(20))
