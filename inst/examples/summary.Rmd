...
```{r summary-histograms, echo=FALSE, message=FALSE, warning=FALSE, fig.width=7, fig.height=5}
...
```{r summary-bars, echo=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=7}
