...
firstnames <- function (...) {
  ...
  first.english <- read.csv(system.file("extdata/names/firstnames/English/yob2013.txt", package = "estc"), header = FALSE)[, 1:2]
  ...
  first.german.male <- read.csv(system.file("extdata/names/firstnames/German/vornamenMale.csv", package = "estc"), header = FALSE, sep = ";")
  first.german.female <- read.csv(system.file("extdata/names/firstnames/German/vornamenFemale.csv", package = "estc"), header = FALSE, sep = ";")
  ...
  first.french <- read.csv(system.file("extdata/names/firstnames/French/Prenoms.txt", package = "estc"), header = TRUE, sep = "\t")[, 1:3]
  ...
  first.french2 <- read.csv(system.file("extdata/names/firstnames/French/Prenoms.csv", package = "estc"), header = FALSE)
  ...
  first.custom <- read.csv(system.file("extdata/names/firstnames/custom.csv", package = "estc"), header = FALSE)
  ...
  #last.custom <- as.character(read.csv(system.file("extdata/names/lastnames/custom.csv", package = "estc"), sep = "\t")[,1])
  ...
  pseudo <- as.character(read.csv(system.file("extdata/names/pseudonymes/first.csv", package = "estc"), sep = "\t")[,1])
...
lastnames <- function (...) {
  ...
  last.census <- as.character(read.csv(system.file("extdata/names/lastnames/last.csv", package = "estc"), sep = "\t")[,1])
  ...
  # mixing first and last names and we do not want to filter out valid names if they
  # happen to be in wrong field last/first
  # first.custom <- as.character(read.csv(system.file("extdata/names/firstnames/custom.csv", package = "estc"), sep = "\t")[,1])

  # Also accept pseudonymes
  pseudo <- as.character(read.csv(system.file("extdata/names/pseudonymes/last.csv", package = "estc"), sep = "\t")[,1])
...
notnames <- function (...) {
  ...
  generic <- as.character(read.csv(system.file("extdata/names/notnames/generic.csv", package = "estc"), sep = "\t")[,1])
  organization <- as.character(read.csv(system.file("extdata/names/notnames/organization.csv", package = "estc"), sep = "\t")[,1])
...
#'    }
#' @export
#' @importFrom bibliographica remove_stopwords
#' 
#' @author Leo Lahti \email{leo.lahti@@iki.fi}
#' @references See citation("estc")
#' 
